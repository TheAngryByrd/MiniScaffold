                                                ...
                                                dd [] [
                                                    a [
                                                        Href(
                                                            sprintf
                                                                "%s.html"
                                                                moduleInfo.ParentModule.Value.UrlName
                                                        )
                                                    ] [ str moduleInfo.ParentModule.Value.Name ]
                                                ]
                                        if
                                            moduleInfo.Module.Attributes
                                            |> Seq.isEmpty
                                            |> not
                                        then
                                ...
                                for g in byCategory do
                                    ...
                                    yield!
                                        partMembers
                                            ...
                                            (g.Members
                                             |> Seq.filter (fun m ->
                                                 m.Kind = MemberKind.ValueOrFunction
                                             ))
                                    ...
                                    yield!
                                        partMembers
                                            ...
                                            (g.Members
                                             |> Seq.filter (fun m ->
                                                 m.Kind = MemberKind.TypeExtension
                                             ))
                                    ...
                                    yield!
                                        partMembers
                                            ...
                                            (g.Members
                                             |> Seq.filter (fun m ->
                                                 m.Kind = MemberKind.ActivePattern
                                             ))
                            ]
                    ]
            ]
